                        ...
                        <tbody className="bg-white divide-y divide-gray-200 text-center">
                            {comparisonData.map((row, i) => (
                                <tr key={i}>
                                    ...
                                    <td>{row.free ? <CheckIcon className="w-5 h-5 text-green-500 mx-auto"/> : '❌'}</td>
                                    <td>{row.standard ? <CheckIcon className="w-5 h-5 text-green-500 mx-auto"/> : '❌'}</td>
                                    <td className="bg-gray-50">{row.pro === true ? <CheckIcon className="w-5 h-5 text-green-500 mx-auto"/> : row.pro === 'add-on' ? <span className="text-xs font-semibold text-blue-600">Add-on</span> : '❌'}</td>
                                    <td>{row.enterprise ? <CheckIcon className="w-5 h-5 text-green-500 mx-auto"/> : '❌'}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
