              ...
              {suggestions.map((suggestion, index) => (
                ...
                >
                  ...
                  <button
                    ...
                    disabled={isLoading}
                    className="mt-3 w-full px-4 py-2 text-sm font-semibold border border-teal-500 text-teal-600 rounded-md hover:bg-teal-500 hover:text-white focus:outline-none focus:ring-2 focus:ring-teal-400 focus:ring-opacity-50 transition-colors disabled:opacity-70 disabled:cursor-not-allowed"
                  >
                    Check this domain
                  </button>
                </motion.div>
